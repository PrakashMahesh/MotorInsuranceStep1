      ...
      <div>
        ...
        <Form.Group>
            ...
            <Form.Group>
                ...
                <Form.Control className="form-field" name="driver_license_number1"  value={this.state.drivers_details[idx].driver_license_number1} onChange={this.handleChange(idx)}/>
