  ...
  about_driver_fields.map((field, i) => {
    if (field.layout === "row") {
      ...
      return (
        ...
        <Button variant="success" onClick={handleBack} className="button-rounded" type="submit" >
          Back
          </Button>
         {'    '}
        <Button variant="success" onClick={handleNext} className="button-rounded" type="submit" onClick={(e) => handleSubmit(e)}>
          Continue
          </Button>
